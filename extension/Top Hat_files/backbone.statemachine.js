...
Backbone.StatefulView = (function(Backbone, _){
    ...
    _.extend(StatefulView.prototype, Backbone.View.prototype, Backbone.StateMachine, {
        ...
        toState: function(name) {
            // from http://stackoverflow.com/questions/10868700/whats-ie-take-on-htmldocument-and-htmlelement
            var element = typeof HTMLElement !== "undefined" ? HTMLElement : Element;
