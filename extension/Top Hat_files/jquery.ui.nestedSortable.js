...
(function($) {
    ...
    $.widget("ui.nestedSortable", $.extend({}, $.ui.sortable.prototype, {
        ...
        _mouseDrag: function(event) {
            ...
            if (this.previousParentItem != null && this.options.placeholderParent !== undefined) {
                this.previousParentItem.removeClass(this.options.placeholderParent);
            }
            if (parentItem != null && this.options.placeholderParent !== undefined) {
                var closestParent = parentItem;
                if (closestParent.hasClass(this.options.disableNesting)) {
                    closestParent = closestParent.closest('li:not(.no_tree_children)');
                }
                this.previousParentItem = closestParent;
                closestParent.addClass(this.options.placeholderParent);
            }
        ...
        _mouseStop: function(event, noPropagation) {
            ...
            if (this.previousParentItem !== undefined && this.options.placeholderParent !== undefined) {
                this.previousParentItem.removeClass(this.options.placeholderParent);
            }
